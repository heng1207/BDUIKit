...
- (NSString*)hardwareDescription
{
    ...
    if ([hardware isEqualToString:@"iPhone11,8"])
        return@"iPhone XR";
...
- (NSString*)hardwareSimpleDescription
{
    ...
    if ([hardware isEqualToString:@"iPad7,1"])      return @"iPad Pro 2 12.9";
    if ([hardware isEqualToString:@"iPad7,2"])      return @"iPad Pro 2 12.9";
